...
class MainTest {
    ...
    void cleanupMapDeleteKey() {
        ...
        Main.cleanup(hashMap, fieldsToCleanup, fieldsToOutput);
    ...
    public void cleanupMapException() {
        ...
        Assert.assertThrows(IllegalArgumentException.class, () -> Main.cleanup(testClass, fieldsToCleanup, fieldsToOutput));
    }
    ...
    public void cleanupObjectNullPrimitive() {
        ...
        Main.cleanup(testClass, fieldsToCleanup, fieldsToOutput);
